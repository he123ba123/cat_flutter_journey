...
class Error<T> implements ProductsState<T> {
...
@override
String toString() {
  return 'ProductsState<$T>.error(errorMessage: $errorMessage)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $ProductsStateCopyWith<T, $Res> {
