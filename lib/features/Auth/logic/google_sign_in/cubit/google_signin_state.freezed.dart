...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GoogleSigninState);
}
...
$GoogleSigninStateCopyWith(GoogleSigninState _, $Res Function(GoogleSigninState) __);
}
...
class Loading implements GoogleSigninState {
  const Loading();
...
class Success implements GoogleSigninState {
  const Success();
...
class Error implements GoogleSigninState {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $GoogleSigninStateCopyWith<$Res> {
