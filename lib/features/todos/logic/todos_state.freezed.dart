...
/// @nodoc
class $TodosStateCopyWith<$Res>  {
$TodosStateCopyWith(TodosState _, $Res Function(TodosState) __);
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<TodoModel> todos)?  success,TResult Function( String error)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Success() when success != null:
return success(_that.todos);case Error() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<TodoModel> todos)  success,required TResult Function( String error)  error,}) {final _that = this;
switch (_that) {
case _Initial():
return initial();case Loading():
return loading();case Success():
return success(_that.todos);case Error():
return error(_that.error);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<TodoModel> todos)?  success,TResult? Function( String error)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Success() when success != null:
...
class _Initial implements TodosState {
  const _Initial();
...
class Success implements TodosState {
  const Success(final  List<TodoModel> todos): _todos = todos;
...
/// @nodoc
abstract mixin class $SuccessCopyWith<$Res> implements $TodosStateCopyWith<$Res> {
...
class Error implements TodosState {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $TodosStateCopyWith<$Res> {
